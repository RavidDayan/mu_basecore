...
// DO NOT MODIFY
// GENERATED ON: 2025-11-16 10:10:58.988965
...
{
  CALL_CRYPTO_SERVICE (MlDsaNew, (MlDsaNid), NULL);
}
...
{
  CALL_CRYPTO_SERVICE (MlDsaGenerateKey, (MlDsaContext, PublicKey, PublicKeySize, PrivateKey, PrivateKeySize), FALSE);
}
...
{
  CALL_CRYPTO_SERVICE (MlDsaSetPublicKey, (MlDsaContext, PublicKey, PublicKeySize), FALSE);
}
...
{
  CALL_CRYPTO_SERVICE (MlDsaSetPrivateKey, (MlDsaContext, PrivateKey, PrivateKeySize), FALSE);
}
...
{
  CALL_CRYPTO_SERVICE (MlDsaSign, (MlDsaContext, Message, MessageSize, Signature, SigSize), FALSE);
}
...
{
  CALL_CRYPTO_SERVICE (MlDsaVerify, (MlDsaContext, Message, MessageSize, Signature, SigSize), FALSE);
}

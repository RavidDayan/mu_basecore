...
// DO NOT MODIFY
// GENERATED ON: 2025-08-22 13:09:45.650240
...
**/
// FROM BaseCryptLib.h:1851
typedef
VOID *
(EFIAPI *EDKII_CRYPTO_ML_DSA_NEW)(
  IN UINTN  MlDsaNid
  );
...
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPTO_ML_DSA_GENERATE_KEY)(
...
**/
// FROM BaseCryptLib.h:1925
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPTO_ML_DSA_SET_PUBLIC_KEY)(
  IN OUT  VOID         *MlDsaContext,
  IN      CONST UINT8  *PublicKey,
  IN      UINTN        PublicKeySize
  );
...
**/
// FROM BaseCryptLib.h:1944
typedef
BOOLEAN
(EFIAPI *EDKII_CRYPTO_ML_DSA_SET_PRIVATE_KEY)(
  IN OUT  VOID         *MlDsaContext,
  IN      CONST UINT8  *PrivateKey,
  IN      UINTN        PrivateKeySize
  );
...
struct _EDKII_CRYPTO_PROTOCOL {
  ...
  // MLDSA
  EDKII_CRYPTO_ML_DSA_NEW                             MlDsaNew;
  EDKII_CRYPTO_ML_DSA_FREE                            MlDsaFree;
  EDKII_CRYPTO_ML_DSA_GENERATE_KEY                    MlDsaGenerateKey;
  EDKII_CRYPTO_ML_DSA_SET_PUBLIC_KEY                  MlDsaSetPublicKey;
  EDKII_CRYPTO_ML_DSA_SET_PRIVATE_KEY                 MlDsaSetPrivateKey;
